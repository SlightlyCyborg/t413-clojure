...
var G__46140 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__46140;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__46142 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__46142,ch);
...
if(("\\" === ch__$1)){
var ch_46143__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_46143__$2 == null)){
cljs.tools.reader.reader_types.reader_error.call(null,rdr,"EOF while reading regex");
} else {
}

sb.append(ch_46143__$2);
} else {
}

var G__46144 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__46144;
continue;
}
}
...
var args46145 = [];
var len__26323__auto___46148 = arguments.length;
var i__26324__auto___46149 = (0);
while(true){
if((i__26324__auto___46149 < len__26323__auto___46148)){
args46145.push((arguments[i__26324__auto___46149]));

var G__46150 = (i__26324__auto___46149 + (1));
i__26324__auto___46149 = G__46150;
continue;
} else {
}
break;
...
var or__25265__auto____$1 = cljs.tools.reader.macros.call(null,ch);
...
var vec__46157 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__46157,(0),null);
var start_column = cljs.core.nth.call(null,vec__46157,(1),null);
...
var G__46158 = cljs.core.conj_BANG_.call(null,a,form);
a = G__46158;
continue;
}
}
...
var _STAR_read_delim_STAR_46160 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_46160;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__46163 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__46163,(0),null);
var start_column = cljs.core.nth.call(null,vec__46163,(1),null);
var the_list = cljs.tools.reader.read_delimited.call(null,")",rdr,opts,pending_forms);
var vec__46164 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__46164,(0),null);
var end_column = cljs.core.nth.call(null,vec__46164,(1),null);
...
var vec__46167 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__46167,(0),null);
var start_column = cljs.core.nth.call(null,vec__46167,(1),null);
var the_vector = cljs.tools.reader.read_delimited.call(null,"]",rdr,opts,pending_forms);
var vec__46168 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__46168,(0),null);
var end_column = cljs.core.nth.call(null,vec__46168,(1),null);
...
var vec__46171 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__46171,(0),null);
var start_column = cljs.core.nth.call(null,vec__46171,(1),null);
...
var vec__46172 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__46172,(0),null);
var end_column = cljs.core.nth.call(null,vec__46172,(1),null);
...
var sb = (function (){var G__46175 = (new goog.string.StringBuffer());
G__46175.append(initch);
...
var G__46177 = (function (){var G__46176 = sb;
G__46176.append(ch);

return G__46176;
})();
var G__46178 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__46177;
ch = G__46178;
continue;
}
...
switch (G__46185) {
case "\\":
var G__46189 = (function (){var G__46186 = sb;
G__46186.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__46186;
})();
var G__46190 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__46189;
ch = G__46190;
continue;
...
break;
default:
var G__46191 = (function (){var G__46187 = sb;
G__46187.append(ch);

return G__46187;
})();
var G__46192 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__46191;
ch = G__46192;
continue;
...
var vec__46194 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__46194,(0),null);
var end_column = cljs.core.nth.call(null,vec__46194,(1),null);
...
var vec__46197 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__46197,(0),null);
var column = cljs.core.nth.call(null,vec__46197,(1),null);
...
var or__25265__auto__ = cljs.core.get.call(null,cljs.tools.reader._STAR_alias_map_STAR_,sym);
if(cljs.core.truth_(or__25265__auto__)){
return or__25265__auto__;
} else {
...
var vec__46206 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__46206,(0),null);
var column = cljs.core.nth.call(null,vec__46206,(1),null);
...
var m__$1 = (cljs.core.truth_((function (){var and__25253__auto__ = line;
...
var vec__46209 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__46209,(0),null);
var column = cljs.core.nth.call(null,vec__46209,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.reader_types.reader_error.call(null,rdr,"Metadata must be Symbol, Keyword, String or Map");
...
var vec__46214 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__46214,(0),null);
var start_column = cljs.core.nth.call(null,vec__46214,(1),null);
var start_column__$1 = (cljs.core.truth_(start_column)?((start_column - (1)) | (0)):null);
var the_set = cljs.core.set.call(null,cljs.tools.reader.read_delimited.call(null,"}",rdr,opts,pending_forms));
var vec__46215 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__46215,(0),null);
var end_column = cljs.core.nth.call(null,vec__46215,(1),null);
...
var G__46217 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__46217,true,null,opts,pending_forms);
...
var _STAR_suppress_read_STAR_46219 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_46219;
}});
...
var G__46221 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__46221,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__46221,rdr,first_line);

return G__46221;
} else {
var or__25265__auto__ = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
if(cljs.core.truth_(or__25265__auto__)){
return or__25265__auto__;
} else {
...
var G__46226 = matched;
var G__46227 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__46226;
finished = G__46227;
continue;
} else {
...
if(cljs.core.not.call(null,(function (){var and__25253__auto__ = opts;
if(cljs.core.truth_(and__25253__auto__)){
...
var _STAR_suppress_read_STAR_46229 = cljs.tools.reader._STAR_suppress_read_STAR_;
cljs.tools.reader._STAR_suppress_read_STAR_ = (function (){var or__25265__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__25265__auto__)){
return or__25265__auto__;
} else {
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_46229;
}}
} else {
return cljs.tools.reader.reader_types.reader_error.call(null,rdr,"EOF while reading character");
}
...
var arg_env46232 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__46233 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__46233,"(");
...
var G__46234 = (i + (1));
var G__46235 = cljs.core.conj_BANG_.call(null,args,(function (){var or__25265__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__25265__auto__)){
return or__25265__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env46232;
}});
/**
...
var ch = temp__4655__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__46237 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__46237);
...
var G__46238 = cljs.core.next.call(null,s__$1);
var G__46239 = ret;
s__$1 = G__46238;
r = G__46239;
continue;
...
var G__46240 = cljs.core.next.call(null,s);
var G__46241 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__46240;
key_vals = G__46241;
continue;
} else {
...
var or__25265__auto__ = cljs.core.get.call(null,cljs.tools.reader.gensym_env,sym);
if(cljs.core.truth_(or__25265__auto__)){
return or__25265__auto__;
} else {
...
if((function (){var and__25253__auto__ = ((!((form == null)))?((((form.cljs$lang$protocol_mask$partition0$ & (262144))) || (form.cljs$core$IWithMeta$))?true:false):false);
...
))))):(cljs.core.truth_((function (){var or__25265__auto__ = (form instanceof cljs.core.Keyword);
if(or__25265__auto__){
return or__25265__auto__;
} else {
var or__25265__auto____$1 = typeof form === 'number';
if(or__25265__auto____$1){
return or__25265__auto____$1;
} else {
var or__25265__auto____$2 = typeof form === 'string';
if(or__25265__auto____$2){
return or__25265__auto____$2;
} else {
var or__25265__auto____$3 = (form == null);
if(or__25265__auto____$3){
return or__25265__auto____$3;
} else {
var or__25265__auto____$4 = cljs.tools.reader.bool_QMARK_.call(null,form);
if(cljs.core.truth_(or__25265__auto____$4)){
return or__25265__auto____$4;
} else {
...
var gensym_env46249 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env46249;
}});
...
var temp__4655__auto__ = (function (){var or__25265__auto__ = cljs.tools.reader._STAR_data_readers_STAR_.call(null,tag);
if(cljs.core.truth_(or__25265__auto__)){
return or__25265__auto__;
} else {
...
var args46256 = [];
var len__26323__auto___46260 = arguments.length;
var i__26324__auto___46261 = (0);
while(true){
if((i__26324__auto___46261 < len__26323__auto___46260)){
args46256.push((arguments[i__26324__auto___46261]));

var G__46262 = (i__26324__auto___46261 + (1));
i__26324__auto___46261 = G__46262;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args46256.length)].join('')));
...
}catch (e46259){if((e46259 instanceof Error)){
var e = e46259;
...
var args46264 = [];
var len__26323__auto___46270 = arguments.length;
var i__26324__auto___46271 = (0);
while(true){
if((i__26324__auto___46271 < len__26323__auto___46270)){
args46264.push((arguments[i__26324__auto___46271]));

var G__46272 = (i__26324__auto___46271 + (1));
i__26324__auto___46271 = G__46272;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args46264.length)].join('')));
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__46267,reader){
var map__46268 = p__46267;
var map__46268__$1 = ((((!((map__46268 == null)))?((((map__46268.cljs$lang$protocol_mask$partition0$ & (64))) || (map__46268.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__46268):map__46268);
var opts = map__46268__$1;
var eof = cljs.core.get.call(null,map__46268__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var args46274 = [];
var len__26323__auto___46277 = arguments.length;
var i__26324__auto___46278 = (0);
while(true){
if((i__26324__auto___46278 < len__26323__auto___46277)){
args46274.push((arguments[i__26324__auto___46278]));

var G__46279 = (i__26324__auto___46278 + (1));
i__26324__auto___46278 = G__46279;
continue;
} else {
}
break;
