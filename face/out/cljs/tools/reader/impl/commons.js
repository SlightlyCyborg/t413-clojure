...
var G__46283 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__46283;
continue;
} else {
return ch;
...
var vec__46285 = cljs.core.re_find.call(null,pattern,s);
var match = cljs.core.nth.call(null,vec__46285,(0),null);
return (match === s);
});
...
var len__26323__auto___46288 = arguments.length;
var i__26324__auto___46289 = (0);
while(true){
if((i__26324__auto___46289 < len__26323__auto___46288)){
args__26330__auto__.push((arguments[i__26324__auto___46289]));

var G__46290 = (i__26324__auto___46289 + (1));
i__26324__auto___46289 = G__46290;
continue;
} else {
}
break;
...
return cljs.tools.reader.impl.commons.read_comment.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__26331__auto__);
});
...
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq46286){
var G__46287 = cljs.core.first.call(null,seq46286);
var seq46286__$1 = cljs.core.next.call(null,seq46286);
return cljs.tools.reader.impl.commons.read_comment.cljs$core$IFn$_invoke$arity$variadic(G__46287,seq46286__$1);
});
cljs.tools.reader.impl.commons.throwing_reader = (function cljs$tools$reader$impl$commons$throwing_reader(msg){
return (function() { 
var G__46291__delegate = function (rdr,_){
return cljs.tools.reader.reader_types.reader_error.call(null,rdr,msg);
};
var G__46291 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__46292__i = 0, G__46292__a = new Array(arguments.length -  1);
while (G__46292__i < G__46292__a.length) {G__46292__a[G__46292__i] = arguments[G__46292__i + 1]; ++G__46292__i;}
  _ = new cljs.core.IndexedSeq(G__46292__a,0);
} 
return G__46291__delegate.call(this,rdr,_);};
G__46291.cljs$lang$maxFixedArity = 1;
G__46291.cljs$lang$applyTo = (function (arglist__46293){
var rdr = cljs.core.first(arglist__46293);
var _ = cljs.core.rest(arglist__46293);
return G__46291__delegate(rdr,_);
});
