...
var x__25920__auto__ = (((server_ch == null))?null:server_ch);
var m__25921__auto__ = (taoensso.sente.interfaces.sch_open_QMARK_[goog.typeOf(x__25920__auto__)]);
if(!((m__25921__auto__ == null))){
return m__25921__auto__.call(null,server_ch);
} else {
var m__25921__auto____$1 = (taoensso.sente.interfaces.sch_open_QMARK_["_"]);
if(!((m__25921__auto____$1 == null))){
return m__25921__auto____$1.call(null,server_ch);
} else {
...
var x__25920__auto__ = (((server_ch == null))?null:server_ch);
var m__25921__auto__ = (taoensso.sente.interfaces.sch_close_BANG_[goog.typeOf(x__25920__auto__)]);
if(!((m__25921__auto__ == null))){
return m__25921__auto__.call(null,server_ch);
} else {
var m__25921__auto____$1 = (taoensso.sente.interfaces.sch_close_BANG_["_"]);
if(!((m__25921__auto____$1 == null))){
return m__25921__auto____$1.call(null,server_ch);
} else {
...
var x__25920__auto__ = (((server_ch == null))?null:server_ch);
var m__25921__auto__ = (taoensso.sente.interfaces._sch_send_BANG_[goog.typeOf(x__25920__auto__)]);
if(!((m__25921__auto__ == null))){
return m__25921__auto__.call(null,server_ch,msg,close_after_send_QMARK_);
} else {
var m__25921__auto____$1 = (taoensso.sente.interfaces._sch_send_BANG_["_"]);
if(!((m__25921__auto____$1 == null))){
return m__25921__auto____$1.call(null,server_ch,msg,close_after_send_QMARK_);
} else {
...
var args46387 = [];
var len__26323__auto___46390 = arguments.length;
var i__26324__auto___46391 = (0);
while(true){
if((i__26324__auto___46391 < len__26323__auto___46390)){
args46387.push((arguments[i__26324__auto___46391]));

var G__46392 = (i__26324__auto___46391 + (1));
i__26324__auto___46391 = G__46392;
continue;
} else {
}
break;
...
var x__25920__auto__ = (((server_ch_adapter == null))?null:server_ch_adapter);
var m__25921__auto__ = (taoensso.sente.interfaces.ring_req__GT_server_ch_resp[goog.typeOf(x__25920__auto__)]);
if(!((m__25921__auto__ == null))){
return m__25921__auto__.call(null,server_ch_adapter,ring_req,callbacks_map);
} else {
var m__25921__auto____$1 = (taoensso.sente.interfaces.ring_req__GT_server_ch_resp["_"]);
if(!((m__25921__auto____$1 == null))){
return m__25921__auto____$1.call(null,server_ch_adapter,ring_req,callbacks_map);
} else {
...
var m__25921__auto__ = (taoensso.sente.interfaces.pack[goog.typeOf(x__25920__auto__)]);
if(!((m__25921__auto__ == null))){
return m__25921__auto__.call(null,_,x);
} else {
var m__25921__auto____$1 = (taoensso.sente.interfaces.pack["_"]);
if(!((m__25921__auto____$1 == null))){
return m__25921__auto____$1.call(null,_,x);
} else {
...
var x__25920__auto__ = (((_ == null))?null:_);
var m__25921__auto__ = (taoensso.sente.interfaces.unpack[goog.typeOf(x__25920__auto__)]);
if(!((m__25921__auto__ == null))){
return m__25921__auto__.call(null,_,x);
} else {
var m__25921__auto____$1 = (taoensso.sente.interfaces.unpack["_"]);
if(!((m__25921__auto____$1 == null))){
return m__25921__auto____$1.call(null,_,x);
} else {
...
taoensso.sente.interfaces.EdnPacker.cljs$lang$ctorPrWriter = (function (this__25863__auto__,writer__25864__auto__,opt__25865__auto__){
return cljs.core._write.call(null,writer__25864__auto__,"taoensso.sente.interfaces/EdnPacker");
});
