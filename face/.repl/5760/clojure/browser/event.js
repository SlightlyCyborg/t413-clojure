...
goog.require('goog.events');
clojure.browser.event.EventType = (function (){var obj16173 = {};return obj16173;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__13469__auto__ = this$;if(and__13469__auto__)
...
{var x__14108__auto__ = (((this$ == null))?null:this$);return (function (){var or__13481__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__14108__auto__)]);if(or__13481__auto__)
{return or__13481__auto__;
} else
{var or__13481__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__13481__auto____$1)
...
return (function (p__16174){var vec__16175 = p__16174;var k = cljs.core.nth.call(null,vec__16175,0,null);var v = cljs.core.nth.call(null,vec__16175,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__16176){var vec__16177 = p__16176;var k = cljs.core.nth.call(null,vec__16177,0,null);var v = cljs.core.nth.call(null,vec__16177,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
