...
goog.require('goog.events');
clojure.browser.event.EventType = (function (){var obj17767 = {};return obj17767;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__13444__auto__ = this$;if(and__13444__auto__)
...
{var x__14083__auto__ = (((this$ == null))?null:this$);return (function (){var or__13456__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__14083__auto__)]);if(or__13456__auto__)
{return or__13456__auto__;
} else
{var or__13456__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__13456__auto____$1)
...
return (function (p__17768){var vec__17769 = p__17768;var k = cljs.core.nth.call(null,vec__17769,0,null);var v = cljs.core.nth.call(null,vec__17769,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__17770){var vec__17771 = p__17770;var k = cljs.core.nth.call(null,vec__17771,0,null);var v = cljs.core.nth.call(null,vec__17771,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
