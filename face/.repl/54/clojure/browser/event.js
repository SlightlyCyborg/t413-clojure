...
goog.require('goog.events');
clojure.browser.event.EventType = (function (){var obj17645 = {};return obj17645;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__13442__auto__ = this$;if(and__13442__auto__)
...
{var x__14081__auto__ = (((this$ == null))?null:this$);return (function (){var or__13454__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__14081__auto__)]);if(or__13454__auto__)
{return or__13454__auto__;
} else
{var or__13454__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__13454__auto____$1)
...
return (function (p__17646){var vec__17647 = p__17646;var k = cljs.core.nth.call(null,vec__17647,0,null);var v = cljs.core.nth.call(null,vec__17647,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__17648){var vec__17649 = p__17648;var k = cljs.core.nth.call(null,vec__17649,0,null);var v = cljs.core.nth.call(null,vec__17649,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
